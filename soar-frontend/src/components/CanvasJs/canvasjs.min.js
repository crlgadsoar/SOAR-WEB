...
(function () {
            ...
            : 'day' === E
              ...
              : 'week' === E
                ...
                : 'month' === E
                  ...
                  : 'year' === E && h.setFullYear(h.getFullYear() + 1 * p);
    return h;
  }
  function ca(h, p) {
    var E = !1;
  ...
  function Ha(h) {
    if (!h) return h;
    h = h.replace(/^\s\s*/, '');
    for (var p = /\s/, E = h.length; p.test(h.charAt(--E)); );
    return h.slice(0, E + 1);
  }
  function Da(h) {
    h.roundRect = function (h, E, r, w, qa, A, B, v) {
      B && (this.fillStyle = B);
      ...
      this.beginPath();
      this.moveTo(h + qa, E);
      this.lineTo(h + r - qa, E);
      this.quadraticCurveTo(h + r, E, h + r, E + qa);
      this.lineTo(h + r, E + w - qa);
      this.quadraticCurveTo(h + r, E + w, h + r - qa, E + w);
  ...
  function J(h, p) {
    ...
    if (
      ...
      for (var r = 0; r < E.length; r++) E[r] *= p;
    else E = [];
    return E;
  }
  function P(h, p, E, w, ha) {
    w = w || [];
    ha = r(ha) ? (gb ? { passive: !1, capture: !1 } : !1) : ha;
    w.push([h, p, E, ha]);
    return h.addEventListener
      ? (h.addEventListener(p, E, ha), E)
      : h.attachEvent
        ? ((w = function (p) {
            p = p || window.event;
            p.preventDefault =
  ...
  function ma(h, p, E) {
    return h in p ? p[h] : E[h];
  }
  function Na(h, p, E, xa) {
    w && ab
      ? ((xa =
          !r(xa) && xa
  ...
  function ib(h) {
    if (!jb) {
      ...
      if (h.creditHref && h.creditText) {
        ...
        if (0 === h.renderCount || p || E)
          h._creditLink.setAttribute('href', ''),
            (h._creditLink.innerHTML = '');
  ...
  function V(h, p) {
    for (var r in p) h.style[r] = p[r];
  }
  function sa(h, p, r) {
    p.getAttribute('state') ||
      ((p.style.backgroundColor = h.toolbar.itemBackgroundColor),
    ...
    p.getAttribute('state') !== r &&
      (p.setAttribute('state', r),
      ...
      (p.innerHTML =
        ...
        "' />"),
      V(p.childNodes[0], { height: '95%', pointerEvents: 'none' }));
    p.setAttribute('title', h._cultureInfo[r + 'Text']);
  }
  function Ma() {
  ...
  function Ta(h, p, r, w, ha) {
    if (null === h || 'undefined' === typeof h)
      return 'undefined' === typeof r ? p : r;
    h =
      parseFloat(h.toString()) * (0 <= h.toString().indexOf('%') ? p / 100 : 1);
    'undefined' !== typeof w &&
      ((h = Math.min(w, h)),
      'undefined' !== typeof ha && (h = Math.max(ha, h)));
    return !isNaN(h) && h <= p && 0 <= h ? h : 'undefined' === typeof r ? p : r;
  }
  function G(h, p, E, w, ha) {
    this._defaultsKey = h;
    ...
    h = {};
    this.theme && r(this.parent) && r(p) && r(w)
      ...
      : this.parent &&
        ...
        (null === w
          ...
          : 0 < this.parent.themeOptions[p].length &&
            ((w = Math.min(this.parent.themeOptions[p].length - 1, w)),
            (h = this.parent.themeOptions[p][w])));
    this.themeOptions = h;
    this.options = E ? E : { _isPlaceholder: !0 };
    this.setOptions(this.options, h);
  }
  function Fa(h, p, r, w, ha) {
  ...
  function za(h, p) {
    za.base.constructor.call(this, 'Title', 'title', p, null, h);
    this.chart = h;
    this.canvas = h.canvas;
    this.ctx = this.chart.ctx;
  ...
  function Ja(h, p, r) {
    Ja.base.constructor.call(this, 'Subtitle', 'subtitles', p, r, h);
    this.chart = h;
    this.canvas = h.canvas;
    this.ctx = this.chart.ctx;
  ...
  var gb = (function () {
      ...
      try {
        ...
        window.addEventListener &&
          ...
          window.removeEventListener('test', null, p));
      } catch (r) {
        h = !1;
      }
      return h;
    ...
    mb = function (h, p, r) {
      ...
      return Math.max(
        'theme4' === this.theme ? 0 : 300 <= p ? 12 : 11,
        Math.round(p * (h / 400)),
      );
    },
    Ba = (function () {
    ...
    nb = function (h) {
      var p = 0 > h;
      if (1 > Math.abs(h)) {
        var r = parseInt(h.toString().split('e-')[1]);
        r &&
          ((h = (p ? -1 * h : h) * Math.pow(10, r - 1)),
          (h = '0.' + Array(r).join('0') + h.toString().substring(2)),
          (h = p ? '-' + h : h));
      } else
        (r = parseInt(h.toString().split('+')[1])),
          20 < r &&
            ((r -= 20),
            (h /= Math.pow(10, r)),
            (h = h.toString() + Array(r + 1).join('0')));
      return String(h);
    },
    da = function (h, p, r) {
      if (null === h) return '';
        ...
        if (((p = J[M]), '.' === p && 0 > K)) K = M;
          ...
          if ('%' === p) A *= 100;
            ...
            ('E' !== p[0] && 'e' !== p[0]) ||
              ...
              (G = !0);
          0 > K
            ? (N.push(p), '#' === p || '0' === p ? P++ : ',' === p && V++)
            : (X.push(p), ('#' !== p && '0' !== p) || T++);
        }
      G &&
        ((p = Math.floor(h)),
        (J = -Math.floor(Math.log(h) / Math.LN10 + 1)),
        (Q = 0 === h ? 0 : 0 === p ? -(P + J) : nb(p).length - P),
        (A /= Math.pow(10, Q)));
      0 > K && (K = M);
      A = (h * A).toFixed(T);
      p = A.split('.');
        ...
        if (((p = N.pop()), '#' === p || '0' === p))
          if ((K++, K === P)) {
            var W = A,
              A = [];
            if ('0' === p)
              for (p = P - T - (W ? W.length : 0); 0 < p; ) W.unshift('0'), p--;
            for (; 0 < W.length; )
              (r = W.pop() + r),
                G++,
                0 === G % J && M === V && 0 < W.length && (r = v + r);
          } else
            0 < A.length
              ? ((r = A.pop() + r), T++, G++)
              : '0' === p && ((r = '0' + r), T++, G++),
              0 === G % J && M === V && 0 < A.length && (r = v + r);
        else
          ('E' !== p[0] && 'e' !== p[0]) ||
          '0' !== p[p.length - 1] ||
          !/[eE][+-]*[0]+/.test(p)
            ? ',' === p
              ? (M++, (J = G), (G = 0), 0 < A.length && (r = v + r))
              : (r =
                  1 < p.length &&
                  (('"' === p[0] && '"' === p[p.length - 1]) ||
                    ("'" === p[0] && "'" === p[p.length - 1]))
    ...
    Oa = 1,
    la = ab ? Sa / Oa : 1,
    Y = function (h, p, r, w, v, B, A, J, K, N, X, T, P) {
      'undefined' === typeof P && (P = 1);
      A = A || 0;
      J = J || 'black';
      var G = 15 < w - p && 15 < v - r ? 8 : 0.35 * Math.min(w - p, v - r);
      h.beginPath();
      h.moveTo(p, r);
      h.save();
      h.fillStyle = B;
      h.globalAlpha = P;
      h.fillRect(p, r, w - p, v - r);
      h.globalAlpha = 1;
      0 < A &&
        ((P = 0 === A % 2 ? 0 : 0.5),
        h.beginPath(),
        ...
        (h.strokeStyle = J),
        h.moveTo(p, r),
        h.rect(p - P, r - P, w - p + 2 * P, v - r + 2 * P),
        h.stroke());
      h.restore();
      !0 === K &&
        (h.save(),
        ...
        h.lineTo(w, r),
        h.closePath(),
        (A = h.createLinearGradient((w + p) / 2, r + G, (w + p) / 2, r)),
        A.addColorStop(0, B),
      ...
      !0 === N &&
        ...
        h.lineTo(w, v),
        h.closePath(),
        (A = h.createLinearGradient((w + p) / 2, v - G, (w + p) / 2, v)),
        A.addColorStop(0, B),
        A.addColorStop(1, 'rgba(255, 255, 255, .4)'),
        (h.fillStyle = A),
        h.fill(),
      ...
      !0 === X &&
        ...
        h.lineTo(p, v),
        h.closePath(),
        (A = h.createLinearGradient(p + G, (v + r) / 2, p, (v + r) / 2)),
        A.addColorStop(0, B),
      ...
      !0 === T &&
        ...
        h.lineTo(w - G, v - G),
        h.lineTo(w, v),
        (A = h.createLinearGradient(w - G, (v + r) / 2, w, (v + r) / 2)),
        A.addColorStop(0, B),
        A.addColorStop(1, 'rgba(255, 255, 255, 0.1)'),
        (h.fillStyle = A),
        A.addColorStop(0, B),
  ...
  G.prototype.setOptions = function (h, p) {
  ...
  G.prototype.set = function (h, p, r) {
  ...
  G.prototype.addTo = function (h, p, r, w) {
    ...
    if ('undefined' !== typeof h || this.options._isPlaceholder)
      if (
        ...
        var p = this.parent.options[this.optionsName],
          r = p.length;
        this.options._isPlaceholder || (Ea(p), (r = p.indexOf(this.options)));
  ...
  G.prototype.updateOption = function (h) {
    ...
    this.themeOptions = w;
    h in p &&
      (v = h in this.options ? this.options[h] : w && h in w ? w[h] : p[h]);
  ...
  Fa.prototype.unRegisterSpace = function (h, p) {
    'top' === h
      ? (this._topOccupied -= p.height)
      : 'bottom' === h
        ? (this._bottomOccupied -= p.height)
  ...
  ja.prototype._getLineWithWidth = function (h, p, r) {
    h = String(h);
    ...
    p = !0;
    if (A.length === h.length || ' ' === h[A.length]) p = !1;
    p &&
      ((h = A.split(' ')),
      1 < h.length && h.pop(),
      (A = h.join(' ')),
  ...
  za.prototype.setLayout = function () {
    if (this.text) {
      ...
      'top' === this.verticalAlign || 'bottom' === this.verticalAlign
        ? ('top' === this.verticalAlign
            ? ((v = p.y1 + 2 + this.fontSize / 2 + 4), (K = 'top'))
            : 'bottom' === this.verticalAlign &&
              ((v = p.y2 - 2 - N.height + this.fontSize / 2 + 4),
              (K = 'bottom')),
          'left' === this.horizontalAlign
            ? (w = p.x1 + 2)
            : 'center' === this.horizontalAlign
              ? (w = p.x1 + p.width / 2 - N.width / 2)
        ...
        : 'center' === this.verticalAlign &&
          ('left' === this.horizontalAlign
            ? ((w = p.x1 + 2 + (this.fontSize / 2 + 4)),
              (v = p.y2 - 2 - (this.maxWidth / 2 - N.width / 2)),
              (B = -90),
              (K = 'left'),
              (this.width = N.height),
              (this.height = N.width))
            : 'right' === this.horizontalAlign
              ? ((w = p.x2 - 2 - (this.fontSize / 2 + 4)),
                (v = p.y1 + 2 + (this.maxWidth / 2 - N.width / 2)),
                (B = 90),
                (K = 'right'),
                (this.width = N.height),
                (this.height = N.width))
  ...
  Va.prototype.get = function (h, r) {
    var w = null;
    0 < this.pool.length
      ? ((w = this.pool.pop()), Na(w, h, r))
      : (w = ua(h, r));
    return w;
  };
  ...
  var Qa = {
    ...
    formatNumber: function (h, r, w) {
      w = w || 'en';
      if (La[w]) return da(h, r || '#,##0.##', new Ka(w));
      throw 'Unknown Culture Name';
    },
    formatDate: function (h, r, w) {
      w = w || 'en';
      if (La[w]) return Ba(h, r || 'DD MMM YYYY', new Ka(w));
      throw 'Unknown Culture Name';
    },
  };
  ...
  B = Qa.Chart = (function () {
        ...
        if (0 == e) c.push(a[0]);
          ...
          c[c.length] =
            (a[t].x > a[f].x && 0 < C) || (a[t].x < a[f].x && 0 > C)
              ...
              : { x: a[t].x, y: a[t].y + (1 === c.length ? 0 : b / 9) };
          t = e;
          f = 0 === t ? 0 : t - 1;
          l = t === a.length - 1 ? t : t + 1;
          b =
        ...
        for (var c = 0; c < this.options.data.length; c++)
          if (
            ...
            !this.options.data[c].type ||
              0 <= p._supportedChartTypes.indexOf(this.options.data[c].type))
          ) {
            var b = new Q(
              this,
              this.options.data[c],
              ...
              : 'xySwapped' === e
                ...
                : 'none' === e
                  ? 'normal' === this.plotInfo.axisPlacement
                    ...
                    : 'xySwapped' === this.plotInfo.axisPlacement
                      ? (f =
                          'You cannot combine "' + b.type + '" with bar chart')
                      : null === this.plotInfo.axisPlacement &&
                                                          ...
                                                          : 'error' === t.type
                                                            ...
                                                            : 'rangeBar' ===
                                                              ...
                                                              : 'rangeArea' ===
                                                                  t.type
                                                                ? (C =
                                                                    this.renderRangeArea(
                                                                      t,
                                                                    ))
                                                                : 'rangeSplineArea' ===
                                                                    t.type
                                                                  ? (C =
                                                                      this.renderRangeSplineArea(
                                                                        t,
                                                                      ))
                                                                  : 'waterfall' ===
                                                                      t.type
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (
          ...
          for (q = 0; q < n.dataPoints.length; q++) {
            ...
            if (0 < q) {
              if (a.axisX.logarithmic) {
                var y = b / n.dataPoints[q - 1].x;
                1 > y && (y = 1 / y);
                c.minDiff > y && 1 !== y && (c.minDiff = y);
              } else
                (y = b - n.dataPoints[q - 1].x),
                  0 > y && (y *= -1),
            ...
            if (b < ba && !g) null !== n.dataPoints[q].y && (h = b);
            else {
              if (!g && ((g = !0), 0 < q)) {
                q -= 2;
                continue;
        ...
        for (
          ...
          for (n = 0; n < m.dataPoints.length; n++) {
            ...
            m.dataPoints[n].x.getTime
              ? ((f = !0), (b = m.dataPoints[n].x.getTime()))
              : (b = m.dataPoints[n].x);
            ...
            if (0 < n) {
              if (a.axisX.logarithmic) {
                var u = b / m.dataPoints[n - 1].x;
                1 > u && (u = 1 / u);
                c.minDiff > u && 1 !== u && (c.minDiff = u);
              } else
                (u = b - m.dataPoints[n - 1].x),
                  0 > u && (u *= -1),
          ...
          for (C = 0; C < t.dataPoints.length; C++)
            ...
            !0 === t.dataPoints[C].isCumulativeSum
              ...
              : 'undefined' !== typeof t.dataPoints[C].isIntermediateSum &&
                ...
                ? ((t.dataPointEOs[C].cumulativeSumYStartValue = n),
                  (t.dataPointEOs[C].cumulativeSum =
                    0 === C ? 0 : t.dataPointEOs[C - 1].cumulativeSum),
                  (t.dataPoints[C].y = 0 === C ? 0 : b),
                  (n = 0 === C ? 0 : t.dataPointEOs[C - 1].cumulativeSum),
                  (b = 0))
                : ((e =
              ...
              if (((m = k[t].max), isFinite(m)))
                for (; t < k.length - 1; )
                  if (((C = k[t + 1].min), isFinite(C))) {
                    n = C - m;
                    n > b && f.push({ diff: n, start: m, end: C });
                    break;
                  } else t++;
      ...
      for (l = 0; l < k.length; l++) {
        ...
        if (q > g)
          var s = g,
            ...
            q = s;
        if (n.scaleBreaks)
          for (s = 0; !f && s < n.scaleBreaks._appliedBreaks.length; s++)
            f =
              n.scaleBreaks._appliedBreaks[s].startValue <= q &&
              n.scaleBreaks._appliedBreaks[s].endValue >= g;
        if (isFinite(n.dataInfo.minDiff))
          if (
            ((s = n.getApparentDifference(q, g, null, !0)),
            !(
              f ||
              (!(
                this.panEnabled &&
                ...
                ((n.logarithmic && s < Math.pow(n.dataInfo.minDiff, 3)) ||
                  (!n.logarithmic && s < 3 * Math.abs(n.dataInfo.minDiff)))) ||
              q < n.minimum ||
              g > n.maximum
            ))
          )
            C.push(n), m.push({ val1: q, val2: g }), (t = !0);
          else if (!e) {
            t = !1;
            break;
          }
    ...
    p.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        var m = this._indexLabels[a],
          ...
          s = ma('indexLabelFontSize', m.dataPoint, m.dataSeries),
        ...
        var ba = ma('indexLabelLineDashType', m.dataPoint, m.dataSeries),
          ...
          p = r(m.dataPoint.indexLabelLineThickness)
        ...
        if (null !== H && '' !== H) {
          ...
          if ('normal' === this.plotInfo.axisPlacement) {
            if (0 <= n.indexOf('line') || 0 <= n.indexOf('area'))
              (x = 'auto'), (t = 4);
            else if (0 <= n.indexOf('stacked')) 'auto' === x && (x = 'inside');
            else if ('bubble' === n || 'scatter' === n) x = 'inside';
            q = m.point.x - ('horizontal' === z ? C / 2 : C / 2 - s / 2);
            'inside' !== x
              ? ((e = c.y1),
                (f = c.y2),
                0 < v
                  ? ((g =
                      m.point.y + ('horizontal' === z ? s / 2 : 0) - k - t - b),
                    g < e &&
                      ((g =
                        'auto' === x
                          ? Math.max(m.point.y, e) + s / 2 + t
                          : e + s / 2 + t),
                      (A = g + k > m.point.y)))
                  : ((g = m.point.y + s / 2 + t + b),
                    g > f - k &&
                      ((g =
                        'auto' === x
                          ? Math.min(m.point.y, f) + s / 2 - k - t
                          : f + s / 2 - k),
                      (A = g < m.point.y))))
              : ((e = Math.max(m.bounds.y1, c.y1)),
                (f = Math.min(m.bounds.y2, c.y2 - k + s / 2)),
                (b =
                  0 <= n.indexOf('range') || 'error' === n
                    ? 0 < v
                      ? Math.max(m.bounds.y1, c.y1) + s / 2 + t
                      : Math.min(m.bounds.y2, c.y2) + s / 2 - k + t
              ...
              'inside' !== x
                  ...
                  0 > v
                    ? ((q =
                      ...
                      q < e &&
                        ...
                        (A = q + C > m.point.x)))
                    : ((q =
                        m.point.x + ('horizontal' === z ? 0 : s / 2) + l + b),
                      q > f - C - l - b &&
                        ((q =
                          'auto' === x
                ...
                : ((e = Math.max(m.bounds.x1, c.x1)),
                  ...
                  (b =
                    0 <= n.indexOf('range') || 'error' === n
                      ? 0 > v
                        ? Math.max(m.bounds.x1, c.x1) + s / 2 + l
                        : Math.min(m.bounds.x2, c.x2) -
                          C / 2 -
                          l +
                          ('horizontal' === z ? 0 : s / 2)
          ...
          p &&
            ...
            d.setLineDash && d.setLineDash(J(ba, p)),
            d.beginPath(),
            ...
            0 <= n.indexOf('bar') || ('error' === n && m.axisSwapped)
              ? d.lineTo(
                  q +
                    (0 < m.direction ? -l : C + l) +
                    ('vertical' === z ? -s / 2 : 0),
                  g + ('vertical' === z ? -k / 2 : k / 2 - s / 2) - t,
                )
              : 0 <= n.indexOf('column') || ('error' === n && !m.axisSwapped)
                ? d.lineTo(
                    q + C / 2 - ('horizontal' === z ? 0 : s / 2),
                    g +
                      ('vertical' === z
                        ? (g - k < m.point.y ? 0 : -k) + t
                        : (g - s / 2 < m.point.y ? k : 0) - s / 2),
                  )
        ...
        for (var f = [], l, t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          var s = k._colorSet,
            h =
              (s =
              k.lineColor =
                k.options.lineColor ? k.options.lineColor : s[0]);
          c.strokeStyle = s;
          var r = !0,
            u = 0,
            p,
          ...
          if (0 < m.length) {
            for (var z = !1, u = 0; u < m.length; u++)
              if (
                ((p = m[u].x.getTime ? m[u].x.getTime() : m[u].x),
                !(
                ...
                if ('number' !== typeof m[u].y)
                  ...
                  r || z
                    ...
                    : (c.lineTo(p, x),
                      ...
                      0 == u % 500 &&
                        ...
                        c.beginPath(),
                        c.moveTo(p, x),
                        w && (b.stroke(), b.beginPath(), b.moveTo(p, x))));
                  l = { x: p, y: x };
                  u < m.length - 1 &&
                    (h !== (m[u].lineColor || s) ||
                      n !== (m[u].lineDashType || k.lineDashType)) &&
                    (c.stroke(),
                    c.beginPath(),
                    c.moveTo(p, x),
                    (h = m[u].lineColor || s),
                  ...
                  if (
                    ...
                    var D = k.getMarkerProperties(u, p, x, c);
                    f.push(D);
                    H = X(H);
                    w &&
                      f.push({
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], l, t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          if (0 < m.length) {
            for (var z = !1, u = 0; u < m.length; u++)
              if (
                ((p = m[u].getTime ? m[u].x.getTime() : m[u].x),
                !(
                  p < a.axisX.dataInfo.viewPortMin ||
                  (p > a.axisX.dataInfo.viewPortMax &&
                    (!k.connectNullData || !z))
                ...
                if ('number' !== typeof m[u].y)
                  ...
                  0 !== m[u].markerSize &&
                    (0 < m[u].markerSize || 0 < k.markerSize) &&
                    ((H = k.getMarkerProperties(u, p, x, c)),
                    f.push(H),
                    (D = X(D)),
                    w &&
                      f.push({
            ...
            for (p = !1, r = 0; r < m.length; r++)
              if (
                ...
                if ('number' !== typeof m[r].y)
                  ...
                  p = a.axisY.convertValueToPixel(m[r].y);
                  ...
                  r < m.length - 1 &&
                    (h !== (m[r].lineColor || s) ||
                      n !== (m[r].lineDashType || k.lineDashType)) &&
                    ((h = m[r].lineColor || s),
                  ...
                  if (
                    0 !== m[r].markerSize &&
                    (0 < m[r].markerSize || 0 < k.markerSize)
                  ) {
                    var H = k.getMarkerProperties(r, u, p, b);
                    l.push(H);
                    z = X(z);
                    w &&
                      l.push({
    ...
    p.prototype.renderColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < s.length)
            for (
              var h = 5 < n && g.bevelEnabled ? !0 : !1, f = 0;
              f < s.length;
              f++
            )
              if (
                (s[f].getTime ? (C = s[f].x.getTime()) : (C = s[f].x),
                !(
                ...
                l = a.axisX.reversed
                  ...
                  : (l -
                      ...
                      (a.previousDataSeriesCount + m) * n) <<
                    0;
                var r = a.axisX.reversed ? (l - n) << 0 : (l + n) << 0,
                  u;
                0 <= s[f].y ? (u = k) : ((u = t), (t = k));
                t > u && ((b = t), (t = u), (u = b));
                b = s[f].color
                ...
                Y(
                  ...
                  0,
                  null,
                  h && (a.axisY.reversed ? 0 > s[f].y : 0 <= s[f].y),
                  (a.axisY.reversed ? 0 <= s[f].y : 0 > s[f].y) && h,
                  !1,
                  !1,
                  g.fillOpacity,
                );
                ...
                (s[f].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    point: {
                      x: l + (r - l) / 2,
                      y: 0 > s[f].y === a.axisY.reversed ? t : u,
                    },
          ...
          if (0 < u.length) {
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                m =
                  (m - (a.plotType.plotUnits.length * s) / 2 + a.index * s) <<
                  0;
                var x = (m + s) << 0,
                  z;
                if (
                ...
                Y(
                  ...
                  0,
                  null,
                  p && (a.axisY.reversed ? 0 > u[k].y : 0 <= u[k].y),
                  (a.axisY.reversed ? 0 <= u[k].y : 0 > u[k].y) && p,
                  !1,
                  !1,
                  r.fillOpacity,
                );
    ...
    p.prototype.renderStackedColumn100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (g = 0; g < a.dataSeriesIndexes.length; g++) {
          ...
          if (0 < u.length)
            for (
              var p = 5 < s && r.bevelEnabled ? !0 : !1, k = 0;
              k < u.length;
              k++
            )
              if (
                ...
                if (
                  ...
                  (C[b] = n + ('undefined' !== typeof C[b] ? C[b] : 0)),
                    (z = a.axisY.convertValueToPixel(C[b])),
                    (n = l[b] ? l[b] : q),
                    (l[b] = z);
              ...
              if (
                ...
                t = a.axisX.reversed
                  ...
                  : (t -
                      ...
                      (a.previousDataSeriesCount + m) * n) <<
                    0;
                var r = a.axisX.reversed ? (t - n) << 0 : (t + n) << 0,
                  u;
                0 <= s[f].y ? (u = k) : ((u = l), (l = k));
                b = s[f].color
                  ? s[f].color
                ...
                Y(
                  ...
                  a.axisX.reversed ? r : t,
                  a.axisY.reversed ? u : l,
                  a.axisX.reversed ? t : r,
                  b,
                  0,
                  null,
                  h,
          ...
          if (0 < u.length) {
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                n =
                  (n - (a.plotType.plotUnits.length * s) / 2 + a.index * s) <<
                  0;
                var x = (n + s) << 0,
                  z;
                if (
    ...
    p.prototype.renderArea = function (a) {
      ...
      function b() {
        H &&
          ...
          f.fill(),
          (f.globalAlpha = 1),
          w && (l.lineTo(r, z), l.lineTo(H.x, z), l.closePath(), l.fill()),
          f.beginPath(),
          f.moveTo(r, u),
          l.beginPath(),
          l.moveTo(r, u),
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          if (0 < s.length) {
            ...
            for (var ea = !0; h < s.length; h++)
              if (
                ((p = s[h].x.getTime ? s[h].x.getTime() : s[h].x),
                !(
                  p < a.axisX.dataInfo.viewPortMin ||
                  (p > a.axisX.dataInfo.viewPortMax &&
                ...
                if ('number' !== typeof s[h].y)
                  g.connectNullData || ea || d || b(), (ea = !0);
                else {
                  r = a.axisX.convertValueToPixel(p);
                  ...
                  h < s.length - 1 &&
                    (A !== (s[h].lineColor || v) ||
                      c !== (s[h].lineDashType || g.lineDashType)) &&
                    (b(),
                    (A = s[h].lineColor || v),
                    (f.strokeStyle = A),
                    f.setLineDash &&
                  ...
                  0 !== s[h].markerSize &&
                    ...
                    ((p = g.getMarkerProperties(h, r, u, f)),
                    C.push(p),
                    ($ = X($)),
                    w &&
                      C.push({
      ...
      function d() {
        ...
        if (0 < c.length) {
          ...
          (0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum)
            ...
            : 0 > a.axisY.viewportMaximum
              ? (p = f.y1)
              : 0 < a.axisY.viewportMinimum && (p = r);
          u = { x: c[0].x, y: c[0].y };
          b.lineTo(c[c.length - 1].x, p);
          b.lineTo(u.x, p);
          b.closePath();
            ...
            for (s = !1; q < n.length; q++)
              if (
                ...
                if ('number' !== typeof n[q].y)
                  ...
                  s = a.axisY.convertValueToPixel(n[q].y);
                  ...
                  if (
                    ...
                    var S = m.getMarkerProperties(q, g, s, b);
                    l.push(S);
                    L = X(L);
                    w &&
                      l.push({
    ...
    p.prototype.renderStepArea = function (a) {
      ...
      function b() {
        H &&
          ...
          f.fill(),
          (f.globalAlpha = 1),
          w && (l.lineTo(p, z), l.lineTo(H.x, z), l.closePath(), l.fill()),
          f.beginPath(),
          f.moveTo(p, u),
          l.beginPath(),
          l.moveTo(p, u),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          c = !1;
          if (0 < s.length) {
            var D = g._colorSet[r % g._colorSet.length],
              v = (g.lineColor = g.options.lineColor || D),
              A = v;
            f.fillStyle = D;
            f.strokeStyle = v;
            ...
            for (; r < s.length; r++)
              if (
                ((y = s[r].x.getTime ? s[r].x.getTime() : s[r].x),
                !(
                ...
                'number' !== typeof s[r].y
                  ...
                  : ((p = a.axisX.convertValueToPixel(y)),
                    (u = a.axisY.convertValueToPixel(s[r].y)),
                    d || c
                      ? (!d && g.connectNullData
                          ? (f.setLineDash &&
                              (g.options.nullDataLineDashType ||
                            ...
                            f.lineTo(p, $),
                            f.lineTo(p, u),
                            w && (l.lineTo(p, $), l.lineTo(p, u)))
                          : (f.beginPath(),
                            f.moveTo(p, u),
                            w && (l.beginPath(), l.moveTo(p, u)),
                            (H = { x: p, y: u })),
                        (c = d = !1))
                      : (f.lineTo(p, $),
                        w && l.lineTo(p, $),
                    ...
                    r < s.length - 1 &&
                      (A !== (s[r].lineColor || v) ||
                        L !== (s[r].lineDashType || g.lineDashType)) &&
                      (b(),
                      (A = s[r].lineColor || v),
                      (f.strokeStyle = A),
                      f.setLineDash &&
                    ...
                    0 !== s[r].markerSize &&
                      (0 < s[r].markerSize || 0 < g.markerSize) &&
                      (($ = g.getMarkerProperties(r, p, u, f)),
                      h.push($),
                      (y = X(y)),
                      w &&
                        h.push({
                    ...
                    (s[r].indexLabel ||
                      ...
                      this._indexLabels.push({
                        ...
                        dataSeries: g,
                        point: { x: p, y: u },
                        direction: 0 > s[r].y === a.axisY.reversed ? 1 : -1,
                        color: D,
                      }));
              }
            b();
    ...
    p.prototype.renderStackedArea = function (a) {
      function d() {
        if (!(1 > k.length)) {
          ...
          b.globalAlpha = 1;
          b.beginPath();
          w && (p.closePath(), p.fill(), p.beginPath());
          k = [];
        }
      }
      var c = a.targetCanvasCtx || this.plotArea.ctx,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        b.rect(t.x1, t.y1, t.width, t.height);
        b.clip();
        w && (p.beginPath(), p.rect(t.x1, t.y1, t.width, t.height), p.clip());
              ...
              if (
                ...
                if ('number' !== typeof ga.y)
                  ...
                  if (
                    ...
                    s = a.axisY.convertValueToPixel(n[f]);
                  } else (s = a.axisY.convertValueToPixel(ga.y)), (s -= na);
                  k.push({ x: g, y: r - na });
                  h[f] = r - s;
                  y || $
                    ? (!y && D.connectNullData
              ...
              if (
                ...
                if ('number' !== typeof ga.y)
                  ...
                  if (
                    ...
                    if (0 >= n[f] && a.axisY.logarithmic) continue;
                    s = a.axisY.convertValueToPixel(n[f]);
                  } else (s = a.axisY.convertValueToPixel(na)), (s -= ka);
                  k.push({ x: g, y: y - ka });
                  h[f] = y - s;
                  p || $
                    ? (!p && D.connectNullData
                  ...
                  0 <= D.dataPointIndexes[f] &&
                    0 !== ga.markerSize &&
                    (0 < ga.markerSize || 0 < D.markerSize) &&
                    ((ka = D.getMarkerProperties(q, g, s, b)),
                    t.push(ka),
                    (f = X(F)),
                    w &&
                      t.push({
    ...
    p.prototype.renderCandlestick = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
          var ba = a.dataSeriesIndexes[p],
            u = this.data[ba],
            y = u.dataPoints;
          if (0 < y.length)
            for (
              var x = 5 < s && u.bevelEnabled ? !0 : !1, t = 0;
              t < y.length;
              t++
            )
              if (
                ...
                var z = (h - s / 2) << 0,
                  ...
                  D = Math.round(Math.max(1, 0.15 * s)),
                  v = 0 === D % 2 ? 0 : 0.5,
                  A = u.dataPointIds[t];
                ...
                (y[t].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    dataPoint: y[t],
                    dataSeries: u,
                    point: { x: z + (H - z) / 2, y: a.axisY.reversed ? n : m },
                    direction: 1,
                    bounds: {
                      x1: z,
                      y1: Math.min(m, n),
    ...
    p.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          var p = !1, p = !!a.axisY.reversed, ba = 0;
          ...
          if (0 < x.length)
            for (
              var z = 5 < s && y.bevelEnabled ? !0 : !1, l = 0;
              l < x.length;
              l++
            )
              if (
                ...
                n = a.axisY.convertValueToPixel(x[l].y[3]);
                ...
                w &&
                  ...
                  0 < ka &&
                    (b.moveTo(t - B - F, k),
                    b.lineTo(t - B - F, Math.max(h, n)),
                    b.stroke(),
                    b.moveTo(t - B - F, Math.min(h, n)),
                    b.lineTo(t - B - F, m),
                    b.stroke()),
                  Y(
                    b,
                ...
                (x[l].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    dataPoint: x[l],
                    dataSeries: y,
                    point: { x: v + (D - v) / 2, y: a.axisY.reversed ? h : n },
                    direction: 1,
                    bounds: {
                      x1: v,
                      y1: Math.min(h, n),
    ...
    p.prototype.renderRangeColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < g.length)
            for (
              var s = 5 < k && q.bevelEnabled ? !0 : !1, f = 0;
              f < g.length;
              f++
            )
              if (
                ...
                var p = a.axisX.reversed
                    ...
                    : (b -
                        ...
                        (a.previousDataSeriesCount + m) * k) <<
                      0,
                  ba = a.axisX.reversed ? (p - k) << 0 : (p + k) << 0,
                  b = g[f].color
                    ? g[f].color
                ...
                Y(
                  c,
                  a.axisX.reversed ? ba : p,
                  l,
                  a.axisX.reversed ? p : ba,
                  t,
                  b,
                  0,
                  b,
          ...
          if (0 < v.length)
            for (var E = z._colorSet, t = 0; t < v.length; t++) {
              ...
              if (
                ...
                b
                  ...
                  : ((m = a.axisX.reversed
                      ...
                      : (h - ((D ? ba : 1) * u) / 2 + (D ? A - 1 : 0) * u) <<
                        0),
                    (n = a.axisX.reversed ? (m - u) << 0 : (m + u) << 0));
                !b && q > g && ((ea = q), (q = g), (g = ea));
                b && m > n && ((ea = m), (m = n), (n = ea));
                ea = z.dataPointIds[t];
                ...
                w && B(this._eventManager.ghostCtx, m, q, n, g, e, L, S, b);
                if (
                  v[t].indexLabel ||
                  z.indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    indexKeyword: 0,
                    point: {
                      x: b ? (v[t].y[1] >= v[t].y[0] ? m : n) : m + (n - m) / 2,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          var q = a.dataSeriesIndexes[n],
            ...
            s = g.dataPoints;
          if (0 < s.length) {
            var p = 5 < m && g.bevelEnabled ? !0 : !1;
            c.strokeStyle = '#4572A7 ';
            for (f = 0; f < s.length; f++)
              if (
                (s[f].getTime ? (k = s[f].x.getTime()) : (k = s[f].x),
                !(
                  ...
                  !r(s[f].y) &&
                  s[f].y.length &&
                  'number' === typeof s[f].y[0] &&
                  'number' === typeof s[f].y[1])
              ) {
        ...
        for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          if (0 < n.length) {
            ...
            for (var L = !0; g < n.length; g++)
              if (
                ((u = n[g].x.getTime ? n[g].x.getTime() : n[g].x),
                !(
                  u < a.axisX.dataInfo.viewPortMin ||
                  (u > a.axisX.dataInfo.viewPortMax &&
                    (!m.connectNullData || !L))
                ...
                if (
                  ...
                  p = a.axisY.convertValueToPixel(n[g].y[1]);
                  q || L
                    ? (m.connectNullData && !q
                        ? (b.setLineDash &&
                            (m.options.nullDataLineDashType ||
                  ...
                  if (
                    ...
                    var S = m.getMarkerProperties(g, s, p, b);
                    f.push(S);
                    var ea = X(u);
                    w &&
                      f.push({
                    ...
                    S = m.getMarkerProperties(g, s, r, b);
                    f.push(S);
                    ea = X(u);
                    w &&
                      f.push({
            ...
            for (var g = (f = 0); f < d.length - 3; f += 3, g++) {
              if (p[g].newStrokeStyle || p[g].newLineDashArray)
                b.stroke(),
                  b.beginPath(),
                  b.moveTo(d[f].x, d[f].y),
                  p[g].newStrokeStyle && (b.strokeStyle = p[g].newStrokeStyle),
                  p[g].newLineDashArray && b.setLineDash(p[g].newLineDashArray);
              b.bezierCurveTo(
                d[f + 1].x,
                d[f + 1].y,
                d[f + 2].x,
            ...
            for (g = !1; n < m.length; n++)
              if (
                ...
                if (
                  ...
                  s = a.axisY.convertValueToPixel(m[n].y[1]);
                  ...
                  p[p.length] = { x: q, y: g };
                  ba[ba.length] = { x: q, y: s };
                  n < m.length - 1 &&
                    (x !== (m[n].lineColor || y) ||
                      z !== (m[n].lineDashType || k.lineDashType)) &&
                    ((x = m[n].lineColor || y),
                  ...
                  if (
                    ...
                    var G = k.getMarkerProperties(n, q, g, b);
                    f.push(G);
                    var L = X(B);
                    w &&
                      f.push({
                    ...
                    G = k.getMarkerProperties(n, q, s, b);
                    f.push(G);
                    L = X(B);
                    w &&
                      f.push({
                  ...
                  0 < n &&
                    ...
                    (k.connectNullData
                      ? b.setLineDash &&
                        ...
                        (k.options.nullDataLineDashType ||
                          !m[n - 1].lineDashType) &&
                        ((p[p.length - 1].newLineDashArray = D),
          ...
          if (0 < v.length)
            for (
              ...
              if (
                ...
                if (0 < l && !z && p.connectNullData)
                  var B =
                    p.options.nullDataLineDashType || !v[l - 1].lineDashType
                ...
                r =
                  0 === p.dataPointEOs[l].cumulativeSum
                    ? n
                    : a.axisY.convertValueToPixel(
                        p.dataPointEOs[l].cumulativeSum,
                      );
                k =
                  0 === p.dataPointEOs[l].cumulativeSumYStartValue
                    ? n
                    : a.axisY.convertValueToPixel(
                        p.dataPointEOs[l].cumulativeSumYStartValue,
                      );
                h = a.axisX.reversed
                  ? (h +
                ...
                Y(
                  ...
                  a.axisY.reversed ? k : r,
                  a.axisX.reversed ? h : E,
                  a.axisY.reversed ? r : k,
                  L,
                  0,
                  L,
                  x,
    ...
    var pa = function (a, d, c, b, e, f, l, h, r) {
      if (!(0 > c)) {
    ...
    p.prototype.renderPie = function (a) {
        ...
        if (k && m) {
          for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < m.length; e++) {
            ...
            h = f.indexLabelFormatter
              ...
              : f.indexLabel
                ? p.replaceKeywordsWithValue(f.indexLabel, f, k, e)
                : k.indexLabelFormatter
                  ? k.indexLabelFormatter(t)
                  : k.indexLabel
                    ? p.replaceKeywordsWithValue(k.indexLabel, f, k, e)
                    : f.label
                      ? f.label
                      : '';
            p._eventManager.objectMap[l] = n;
            n.center = { x: x.x, y: x.y };
            n.y = f.y;
            n.radius = D;
            n.percentInnerRadius = E;
            n.indexLabelText = h;
            n.indexLabelPlacement = k.indexLabelPlacement;
            ...
            n.indexLabelWrap =
              'undefined' !== typeof f.indexLabelWrap
                ? f.indexLabelWrap
                : k.indexLabelWrap;
            n.indexLabelTextAlign = f.indexLabelTextAlign
            ...
            n.endAngle = n.startAngle + ((2 * Math.PI) / z) * Math.abs(f.y);
            f = (n.endAngle + n.startAngle) / 2;
            f = (f + 2 * Math.PI) % (2 * Math.PI);
            n.midAngle = f;
            if (n.midAngle > Math.PI / 2 - u && n.midAngle < Math.PI / 2 + u) {
            ...
            n.indexLabelTextBlock = new ja(p.plotArea.ctx, {
          ...
          for (e = 0; e < m.length; e++)
            (n = g[(c + e) % m.length]),
              1 < a &&
                n.midAngle > Math.PI / 2 - u &&
                n.midAngle < Math.PI / 2 + u &&
                (f <= a / 2 && !h
                  ? ((n.hemisphere = 'right'), f++)
                  : ((n.hemisphere = 'left'), (h = !0)));
          h = !1;
          for (e = 0; e < m.length; e++)
            (n = g[(d + e) % m.length]),
              1 < b &&
      ...
      function f(a, c, d) {
        ...
        if (0 <= a && a < m.length) {
          var h = g[a];
          if (
            (0 > c && h.indexLabelTextBlock.y < k) ||
            (0 < c && h.indexLabelTextBlock.y > n)
          )
            return 0;
          var q = 0,
            t = 0,
            t = (q = q = 0);
          0 > c
            ? h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 > k &&
              h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 + c <
                k &&
              (c = -(
                k -
                (h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 + c)
          ...
          k =
            'right' === h.hemisphere
              ...
              : x.x - Math.sqrt(Math.pow(w, 2) - Math.pow(c - x.y, 2));
          t = x.x + D * Math.cos(h.midAngle);
          q = x.y + D * Math.sin(h.midAngle);
          q = Math.sqrt(Math.pow(k - t, 2) + Math.pow(c - q, 2));
          t = Math.acos(D / w);
          q = Math.acos((w * w + D * D - q * q) / (2 * D * w));
          c = q < t ? c - h.indexLabelTextBlock.y : 0;
          k = null;
          for (n = 1; n < m.length; n++)
            if (
              ((k = (a - n + g.length) % g.length),
            ...
            ? ((n = 'right' === h.hemisphere ? t : q),
              ...
              null !== n &&
                ...
                c - t < s &&
                  ((k = -t),
                  (n = f(n, k, d + 1)),
                  +n.toFixed(y) > +k.toFixed(y) &&
                    (l = c > s ? -(c - s) : -(t - (n - k))))))
            : 0 < c &&
              ((n = 'right' === h.hemisphere ? q : t),
              (l = c),
              null !== n &&
                ((t = c),
                (c =
                ...
                c - t < s &&
                  ...
                  +n.toFixed(y) < +k.toFixed(y) &&
                    (l = c > s ? c - s : t - (k - n)))));
          l &&
            ((d = h.indexLabelTextBlock.y + l),
            (c = 0),
            (c =
              'right' === h.hemisphere
                ? x.x + Math.sqrt(Math.pow(w, 2) - Math.pow(d - x.y, 2))
                : x.x - Math.sqrt(Math.pow(w, 2) - Math.pow(d - x.y, 2))),
            h.midAngle > Math.PI / 2 - u && h.midAngle < Math.PI / 2 + u
            ...
            (h.indexLabelAngle = Math.atan2(
              h.indexLabelTextBlock.y - x.y,
              h.indexLabelTextBlock.x - x.x,
            )));
        }
        return l;
      }
            ...
            for (var t, r, a = 0; a < m.length; a++) {
              ...
              if (null !== u) {
                ...
                var z = 0,
                  z = b(t, r) - s;
                if (0 > z) {
                  for (var A = (r = 0), H = 0; H < m.length; H++)
                    H !== a &&
      ...
      function h() {
        ...
        p.title &&
          (p.title.dockInsidePlotArea ||
            ('center' === p.title.horizontalAlign &&
              'center' === p.title.verticalAlign)) &&
          p.title.render();
        if (p.subtitles)
        ...
        p.legend &&
          (p.legend.dockInsidePlotArea ||
            ('center' === p.legend.horizontalAlign &&
              'center' === p.legend.verticalAlign)) &&
          (p.legend.setLayout(), p.legend.render());
      }
      var p = this;
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        if (0 !== z) {
          ...
          this.pieDoughnutClickHandler = function (a) {
            p.isAnimating ||
              ...
              1 < this.dataPoints.length &&
                p._animator.animate(0, 500, function (a) {
                  c(a);
                  h();
          ...
          this._animator.animate(
            ...
            function (a) {
              ...
              h();
              p.dispatchEvent('dataAnimationIterationEnd', { chart: p });
              1 <= a && p.dispatchEvent('dataAnimationEnd', { chart: p });
            },
            function () {
              p.disableToolTip = !1;
    ...
    p.prototype.renderFunnel = function (a) {
      ...
      function c() {
        ...
        if (0 === g) return -1;
        for (
          var k = (d[0] = 0), m = 0, h, n, b = b - a, k = !1, l = 0;
          l < y.length;
          l++
        )
      ...
      function b() {
        if (u && y) {
          ...
          for (var D = 0, B = y.length - 1; D < y.length || 0 <= B; D++, B--) {
            ...
            p = b.indexLabelTextAlign || u.indexLabelTextAlign || 'left';
            d =
            ...
            m = b.indexLabelFontWeight || u.indexLabelFontWeight || 'normal';
      ...
      function l() {
          ...
          for (var l, h = 1; h < k; h++) {
            ...
            for (var t = I.length - 1; 0 <= t; t--)
              !I[t].isDirty &&
                ...
                ((l = q(t)),
                !(l >= I.length - 1) &&
                  I[t].textBlock.y + I[t].height + da > I[l].textBlock.y &&
                  (I[t].textBlock.y =
        ...
        for (var d, e, f, g, k, l, m = 1, s = 0; s < 2 * m; s++) {
          for (
            var p = I.length - 1;
            0 <= p &&
            !(0 <= n(p) && n(p),
            (f = I[p]),
            (g = f.textBlock),
            (l = (k = q(p) < R.length ? I[q(p)] : null) ? k.textBlock : null),
            (d = +f.height.toFixed(6)),
            (e = +g.y.toFixed(6)),
            !f.isDirty &&
              k &&
              e + d + da > +l.y.toFixed(6) &&
              ((d = g.y + d + da - l.y),
              (e = a(p, -d)),
              e < d && (0 < e && (d -= e), (e = a(q(p), d)), e != d)));
            p--
          );
          b();
        }
      ...
      function p(a, b, c) {
        ...
        a._animator.animate(
          ...
          function (c) {
            ...
            v(d);
            L && ('inside' !== u.indexLabelPlacement ? m(d) : f(), s(d));
            1 <= c && (ha = !1);
          },
          null,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        if (0 != u.length && u.dataPoints && u.visible && 0 !== y.length) {
          ...
          if (-1 !== S) {
            ...
            !A.animationEnabled && S
              ? p(A, -1, 0)
              : A.animationEnabled && !A.animatedRender && p(A, -1, 0);
            ...
            return {
              ...
              animationCallback: function (a, b) {
                ...
                1 <= a && (p(A, -1, 500), v(A.plotArea.ctx || A.ctx));
              },
              easingFunction: M.easing.easeInQuad,
              animationBase: 0,
            };
    ...
    p.prototype.replaceKeywordsWithValue = function (a, d, c, b, e) {
      ...
      if (
        ...
        var l = '#percent',
          h = '#total',
          p = this.getPercentAndTotal(c, d),
          h = isNaN(p.total) ? h : p.total,
          l = isNaN(p.percent) ? l : p.percent;
        do {
          p = '';
          ...
          a = a.replace('#percent', da(l, p, f._cultureInfo));
          a = a.replace(
            '#total',
            da(
              h,
            ...
            var q = (n.legendMarkerType = n.legendMarkerType
              ...
              g = n.legendText
                ...
                : this.itemTextFormatter
                  ...
                  : n.name,
              s = (n.legendMarkerColor = n.legendMarkerColor
                ? n.legendMarkerColor
                : n.markerColor
                  ? n.markerColor
                  : 'error' === n.type
              ...
              u = n.legendMarkerBorderThickness
                ...
                : n.markerBorderThickness
                  ...
                  : 0;
            'error' === n.type && this.errorMarkerColor.push(s);
            g = this.chart.replaceKeywordsWithValue(g, n.dataPoints[0], n, m);
            q = {
              markerType: q,
              markerColor: s,
              text: g,
            ...
            for (var y = 0; y < n.dataPoints.length; y++) {
              var x = n.dataPoints[y],
                ...
                s = x.legendMarkerColor
                  ...
                  : n.legendMarkerColor
                    ...
                    : x.color
                      ...
                      : n.color
                        ? n.color
                        : n._colorSet[y % n._colorSet.length],
                ...
                u = x.legendMarkerBorderThickness
                  ...
                  : n.legendMarkerBorderThickness
                    ? n.legendMarkerBorderThickness
                    : x.markerBorderThickness || n.markerBorderThickness
                      ? Math.max(1, Math.round(0.2 * w))
                      : 0,
                g = this.chart.replaceKeywordsWithValue(g, x, n, y),
                q = {
                  markerType: q,
                  markerColor: s,
                  text: g,
              ...
              (x.showInLegend || (n.showInLegend && !1 !== x.showInLegend)) &&
                p.push(q);
            }
      }
    ...
    K.prototype.render = function () {
      ...
      for (var h = 0, p = 0; p < l.length; p++) {
        for (var k = l[p], m = 0, n = 0; n < k.items.length; n++) {
          var q = k.items[n],
            g =
          ...
          this.ghostCtx.fillRect(
            ...
            q.textBlock.x + q.textBlock.width - r,
            q.textBlock.height ? q.textBlock.height : this.lineHeight,
          );
              ...
              case 'doughnut':
                ...
                v =
                  'doughnut' === this.type
                    ...
                    : 0;
                s = Math.sqrt(Math.pow(w.x - a, 2) + Math.pow(w.y - d, 2));
                s < q.radius &&
                  s > v &&
                  ((s = Math.atan2(d - w.y, a - w.x)),
                  0 > s && (s += 2 * Math.PI),
                  (s = Number(
                    ((((180 * (s / Math.PI)) % 360) + 360) % 360).toFixed(12),
                  )),
                  (w = Number(
                    (
              ...
              case 'pyramid':
                ...
                d > s.y1 &&
                  ...
                  (s.y6
                    ? d > s.y6
                      ? ((f =
                          s.x6 + ((s.x5 - s.x6) / (s.y5 - s.y6)) * (d - s.y6)),
                        (s =
                          s.x3 + ((s.x4 - s.x3) / (s.y4 - s.y3)) * (d - s.y3)))
                      : ((f =
                          s.x1 + ((s.x6 - s.x1) / (s.y6 - s.y1)) * (d - s.y1)),
                        (s =
                          s.x2 + ((s.x3 - s.x2) / (s.y3 - s.y2)) * (d - s.y2)))
                    : ((f =
                        s.x1 + ((s.x4 - s.x1) / (s.y4 - s.y1)) * (d - s.y1)),
                      (s =
                        s.x2 + ((s.x3 - s.x2) / (s.y3 - s.y2)) * (d - s.y2))),
                  a > f &&
                    a < s &&
      ...
      var e = this.dataPoints,
        ...
        l = e[a].markerBorderColor
          ...
          : this.markerBorderColor
            ? this.markerBorderColor
            : null,
        h = r(e[a].markerBorderThickness)
          ? this.markerBorderThickness
            ? this.markerBorderThickness
            : null
          : e[a].markerBorderThickness,
        p = e[a].markerType ? e[a].markerType : this.markerType;
    ...
    A.setLayout = function (a, d, c, b, e, f) {
      ...
      for (g = 0; g < q.length; g++)
        if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length)
          for (
            var s = q[g].scaleBreaks._appliedBreaks, w = 0;
            w < s.length && !(s[w].startValue > q[g].viewportMaximum);
            w++
          )
            s[w].endValue < q[g].viewportMinimum ||
              (r(q[g].scaleBreaks.firstBreakIndex) &&
                (q[g].scaleBreaks.firstBreakIndex = w),
              s[w].startValue >= q[g].viewPortMinimum &&
      ...
      if ('normal' === e) {
        for (
          ...
          p = Math.round(
            f.x2 - aa - Z > m.width - n ? m.width - n : f.x2 - aa - Z,
          );
          if (a && 0 < a.length)
            for (y = [], g = W = 0; g < a.length; g++)
              a[g] && (a[g].lineCoordinates = {}),
                (a[g].lineCoordinates.width = Math.abs(p - l)),
                a[g].title &&
          ...
          if (d && 0 < d.length)
            for (x = [], g = Y = 0; g < d.length; g++)
              d[g] && (d[g].lineCoordinates = {}),
                (d[g].lineCoordinates.width = Math.abs(p - l)),
                d[g].title &&
                  ...
                  0 < h
                    ...
                    : a[g].viewportMaximum === a[g].maximum &&
                      ...
                      : a[g].viewportMaximum === a[g].maximum &&
                        ...
                        (0 < E && (l += E), 0 < h && (p -= h))),
                m.panEnabled
                  ? (W = r(m.sessionVariables.axisX.height)
                      ? (m.sessionVariables.axisX.height = W)
                      : m.sessionVariables.axisX.height)
                  : (m.sessionVariables.axisX.height = W),
                (h = Math.round(f.y2 - W - e + F)),
                (k = Math.round(f.y2)),
                (a[g].lineCoordinates.x2 = p),
                (a[g].lineCoordinates.width = p - l),
              ...
              b[g] &&
                ...
                (O =
                  b[g]._labels && 0 < b[g]._labels.length
                    ...
                    : 0),
                (h = Math.round(
                  f.y1 + Y + V < Math.max(O, n) ? Math.max(O, n) : f.y1 + Y + V,
                )),
                (O =
                  0 < a.length
                    ? 0
        ...
        for (Q = []; 4 > w; ) {
          ...
          if (c && 0 < c.length)
            for (g = 0; g < c.length; g++)
              (c[g].lineCoordinates = {}),
                ...
                (c[g].lineCoordinates.x2 = p),
                (c[g].lineCoordinates.width = Math.abs(p - l)),
                c[g].title &&
                  (c[g]._titleTextBlock.maxWidth =
                    0 < c[g].titleMaxWidth &&
          ...
          if (b && 0 < b.length)
            for (g = 0; g < b.length; g++)
              (b[g].lineCoordinates = {}),
                ...
                (b[g].lineCoordinates.x2 = p),
                (b[g].lineCoordinates.width = Math.abs(p - l)),
                b[g].title &&
                  (b[g]._titleTextBlock.maxWidth =
                    0 < b[g].titleMaxWidth &&
          ...
          if (m.panEnabled)
            for (g = 0; g < c.length; g++)
              n[g] = r(m.sessionVariables.axisY[g].height)
          ...
          if (c && 0 < c.length)
            for (g = c.length - 1; 0 <= g; g--)
              (h = Math.round(f.y2)),
                ...
                (c[g].lineCoordinates.y1 = h - (n[g] + c[g].margin + Y)),
                (c[g].lineCoordinates.y2 = h - (n[g] + c[g].margin + Y)),
                'inside' === c[g].labelPlacement &&
                  0 < g &&
            ...
            for (g = 0; g < a.length; g++) {
              ...
              if (b && 0 < b.length)
                for (O = 0; O < b.length; O++)
                  b[O] &&
                    b[O].labelAutoFit &&
                    ((p = b[O].lineCoordinates.x1), (l = p - U));
              a[g].lineCoordinates = {
                x1: p - N,
                y1: h,
                x2: p - N,
            ...
            for (g = 0; g < d.length; g++) {
              ...
              if (b && 0 < b.length)
                for (O = 0; O < b.length; O++)
                  b[O] &&
                    b[O].labelAutoFit &&
                    ((p = b[O].lineCoordinates.x2), (l = p - W));
              d[g].lineCoordinates = {
                x1: p + P,
                y1: h,
                x2: p + P,
      ...
      for (var a = 0; a < this.stripLines.length; a++)
        if (
          ...
          this.stripLines[a].value = this.convertPixelToValue(
            Math.abs(
              this.convertValueToPixel(d) + this.convertValueToPixel(c),
            ) / 2,
          );
          ...
          if (
            ...
            for (
              var c = [],
                ...
                p = this.lineCoordinates.width / Math.log(this.range),
          ...
          if (
            ...
            for (
              var c = [],
                m,
                h = this.viewportMaximum,
                p = this.lineCoordinates.height / Math.log(this.range),
                k = this._labels.length - 1;
              0 <= k;
              k--
            ) {
                  ...
                  : 'left' === this._position
                    ? ((n =
                        1 === this.ctx.lineWidth % 2
                          ...
                          : b.y << 0),
                      this.ctx.beginPath(),
                      this.ctx.moveTo(b.x << 0, n),
                      this.ctx.lineTo((b.x - this.tickLength) << 0, n),
                      this.ctx.stroke(),
                      0 === this.labelAngle
                        ? (b.x =
                            b.x -
              ...
              m._thicknessType === a &&
                ...
                'bottom' === this._position
                  ? ((c.textBlock.maxWidth = this.options.stripLines[e]
                    ...
                    b.x - c.textBlock.height - m.thickness / 2 >
                  ...
                  : 'top' === this._position
                    ...
                    : 'left' === this._position
                      ? ((c.textBlock.maxWidth = this.options.stripLines[e]
                        ...
                        (c.textBlock.angle = 0),
                        c.textBlock.measureText(),
                        b.y - c.textBlock.height - m.thickness / 2 >
                        this.chart.plotArea.y1
                          ? r(m.startValue)
                            ? (b.y -=
                                c.textBlock.height -
                    ...
                    : 0 === f - e
                      ...
                      : e > f
                        ? ((b = Math.min(
                            0.01 *
                              Math.abs(
                                this.getApparentDifference(f, e, null, !0),
                              ),
                            5,
                          )),
                          0 <= f ? (e = f - b) : (f = isFinite(e) ? e + b : 0))
                        : ((b = Math.min(
                            0.01 *
                              Math.abs(
                                this.getApparentDifference(e, f, null, !0),
                              ),
                            0.05,
                          )),
                          0 !== f && (f += b),
          ...
          if (
            ...
            'top' === this.scaleBreaks.parent._position
              ...
              : ((e = this.chart.plotArea.y2),
                ...
                (a *= -1)),
            (this.bounds = { x1: b - n / 2, y1: e, x2: h + n / 2, y2: p }),
            this.ctx.moveTo(b, e),
            'straight' === this.type ||
              ('top' === this.scaleBreaks.parent._position && 0 >= a) ||
              ('bottom' === this.scaleBreaks.parent._position && 0 <= a))
          )
            this.ctx.lineTo(b, p), this.ctx.lineTo(h, p), this.ctx.lineTo(h, e);
          ...
          if (
            ...
            'left' === this.scaleBreaks.parent._position
              ? ((b = this.chart.plotArea.x1),
                (h = (this.chart.plotArea.x2 + n / 2 + 0.5) << 0))
              : ((b = this.chart.plotArea.x2),
                (h = (this.chart.plotArea.x1 - n / 2 + 0.5) << 0),
                (a *= -1)),
            (this.bounds = { x1: b, y1: e - n / 2, x2: h, y2: p + n / 2 }),
            this.ctx.moveTo(b, e),
            'straight' === this.type ||
              ('left' === this.scaleBreaks.parent._position && 0 >= a) ||
              ('right' === this.scaleBreaks.parent._position && 0 <= a))
          )
            this.ctx.lineTo(h, e), this.ctx.lineTo(h, p), this.ctx.lineTo(b, p);
          else if ('wavy' === this.type) {
            r = b;
            k = e;
            f = 0.5;
            ...
            m = (h - r) / a / 2;
            for (q = 0; q < m; q++)
              this.ctx.lineTo(r, k), (k += 2 * f * a), (r += 2 * a), (f *= -1);
            this.ctx.lineTo(r, k);
            k += p - e;
            for (q = 0; q < m + 1; q++)
              this.ctx.lineTo(r, k), (k += 2 * f * a), (r -= 2 * a), (f *= -1);
      ...
      if (0 < d) {
        ...
        if (
          ...
          (e = f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0),
            ...
            (p = this.chart.plotArea.y2),
            (this.bounds = { x1: e - d / 2, y1: h, x2: f + d / 2, y2: p });
        else if (
          'left' === this.parent._position ||
          'right' === this.parent._position
        )
          (h = p = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0),
            (e = this.chart.plotArea.x1),
            (f = this.chart.plotArea.x2),
            (this.bounds = { x1: e, y1: h - d / 2, x2: f, y2: p + d / 2 });
        this.ctx.moveTo(e, h);
        this.ctx.lineTo(f, p);
        this.ctx.stroke();
    ...
    ca.prototype.render = function (a, d, c) {
      ...
      0 < n && q.setLineDash && q.setLineDash(J(this.lineDashType, n));
      k = new ja(q, {
        x: 0,
        y: 0,
      ...
      if (this.snapToDataPoint) {
        ...
        if ('xySwapped' === this.chart.plotInfo.axisPlacement) {
          ...
          for (var B = 0; B < this.parent.dataSeries.length; B++)
            (v = this.parent.dataSeries[B].getDataPointAtX(s, !0)) &&
              0 <= v.index &&
            ...
            for (
              ...
              if (m[s].dataPoint.y && m[s].dataPoint.y.length)
                for (var y = 0; y < m[s].dataPoint.y.length; y++)
                  (u = Math.abs(
                    a - this.parent.convertValueToPixel(m[s].dataPoint.y[y]),
                  )),
                    u < v && ((v = u), (B = s));
              else
                (u = Math.abs(
              ...
              if (m[s].dataPoint.y && m[s].dataPoint.y.length)
                ...
                (x += m[s].dataPoint.y),
                  (z = m[s].dataPoint.x.getTime
                    ...
                    : m[s].dataPoint.x),
                  (z = 100 * (x / m[s].dataSeries.plotUnit.dataPointYSums[z])),
          ...
          if (
            ...
            if (
              ...
              for (s = u = 0; s < y.dataPoint.y.length; s++)
                (u = Math.abs(
                  a - this.parent.convertValueToPixel(y.dataPoint.y[s]),
                )),
                  u < v && ((v = u), (b = s));
              p =
                1 === q.lineWidth % 2
            ...
            this.bounds = { x1: b - n / 2, y1: f, x2: e + n / 2, y2: h };
            ...
            this.bounds = { x1: b, y1: f - n / 2, x2: e, y2: h + n / 2 };
            z = !1;
            if (this.parent.labels)
              for (
                m = Math.ceil(this.parent.interval), s = 0;
          ...
          if (z) {
            if ('axisX' === this.parent.type)
              for (
                s = this.parent.convertPixelToValue({ x: a }), v = null, B = 0;
                B < this.parent.dataSeries.length;
                B++
              )
                (v = this.parent.dataSeries[B].getDataPointAtX(s, !0)) &&
          ...
          if (
            ...
            for (
              ...
              if (m[s].dataPoint.y && m[s].dataPoint.y.length)
                for (y = 0; y < m[s].dataPoint.y.length; y++)
                  (u = Math.abs(
                    d - this.parent.convertValueToPixel(m[s].dataPoint.y[y]),
                  )),
                    u < v && ((v = u), (B = s));
              else
                (u = Math.abs(
                  d - this.parent.convertValueToPixel(m[s].dataPoint.y),
                )),
                  u < v && ((v = u), (B = s));
          else if (
          ...
          if (
            ...
            for (s = u = 0; s < y.dataPoint.y.length; s++)
              (u = Math.abs(
                d - this.parent.convertValueToPixel(y.dataPoint.y[s]),
              )),
                u < v && ((v = u), (b = s));
            w =
              1 === q.lineWidth % 2
        ...
        if (
          ...
          (b = e = p = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0),
            (f = this.chart.plotArea.y1),
            (h = this.chart.plotArea.y2),
            (this.bounds = { x1: b - n / 2, y1: f, x2: e + n / 2, y2: h });
        else if (
      ...
      if ('bottom' === this.parent._position || 'top' === this.parent._position)
        this._updatedValue = this.parent.convertPixelToValue(p);
      ...
      if (!this.chart.disableToolTip) {
        ...
        if (
            ...
            for (var v = 0; v < this.chart.axisX.length; v++) {
              for (
                ...
                (k = this.chart.axisX[v].dataSeries[b].getDataPointAtX(h, c)) &&
                  ...
                  null !== k.dataPoint.y && k.dataSeries.visible && p.push(k));
              k = null;
            }
          ...
          for (b = 0; b < p.length; b++)
            p[b].dataPoint.x.valueOf() === c.dataPoint.x.valueOf() &&
              f.push(p[b]);
          p = null;
        } else {
                  ...
                  'column' === e.type || 'bar' === e.type
                    ...
                    : 'bubble' === e.type
                      ? ((c =
                        ...
                        k.dataPoint.y >=
                          k.dataSeries.axisY.viewportMinimum - c &&
                          k.dataPoint.y <=
                              ...
                              this.options.borderColor
                                ...
                                : f[0].dataPoint.color
                                  ...
                                  : f[0].dataSeries.color
                                    ...
                                    : f[0].dataSeries._colorSet[
                                        f[0].index %
                                          f[0].dataSeries._colorSet.length
                                      ])),
    ...
    U.prototype.getToolTipInnerHTML = function (a) {
      ...
      if (
        ...
        for (var p = null, r = '', h = 0; h < a.length; h++) {
          c = a[h].dataSeries;
          b = a[h].dataPoint;
          e = a[h].index;
          f = '';
    ...
    var M = {
      ...
      W = {
        drawMarker: function (a, d, c, b, e, f, h, p) {
          if (c) {
            var r = 1;
