...
class PhishingPlaybook:
    ...
    def execute(self, data):
        ...
        data["miterTechniqueNo"] = str(data.get("miter_technique_no", "T0000"))
        ...
        # Action: Quarantine Email + Block URL (Combined as comma-separated)
        data["action"] = "quarantine_email,block_url"
        ...
        print(f"✅ Phishing attack detected, sending message to {self.waf_ip}:{self.waf_port}")
        ...
        byte_data = struct.pack(
            ...
            encode_fixed_length(data["action"], 100),  # Increased to 100 bytes for multiple actions
        )
